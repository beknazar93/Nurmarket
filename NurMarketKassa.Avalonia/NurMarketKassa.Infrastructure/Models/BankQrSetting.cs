...
namespace NurMarketKassa.Models
{
    public class BankQrSetting : INotifyPropertyChanged
    {
        ...
        /// <summary>True for banks the cashier added themselves (Настройки → Операции → "Добавить банк"),
        /// as opposed to the app's built-in default list — controls whether a "delete whole row" button
