...
- Исправлено: чек со скидкой на сумму не проводился — касса писала «Оплата не прошла. Проверьте параметры скидки», хотя со скидкой всё было в порядке. Скидка отправлялась на сервер дважды: сначала при переносе чека, потом ещё раз при оплате тем же значением — второго раза сервер не переживал. Теперь повторная отправка не делается
